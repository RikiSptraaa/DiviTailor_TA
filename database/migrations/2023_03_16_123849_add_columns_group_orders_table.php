...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('group_orders', function (Blueprint $table) {
            $table->date('tanggal_estimasi')->after('group_order_date');
            $table->tinyInteger('jenis_pakaian')->after('tanggal_estimasi');
            $table->tinyInteger('jenis_kain')->comment('Jenis Kain 1.Wool 2.Cotton 3.Linen 4.Jean 5.High Twist')->after('jenis_pakaian');
