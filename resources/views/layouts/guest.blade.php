...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            <div>
                <a href="/">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="120" height="150" viewBox="0 0 299.000000 156.000000" preserveAspectRatio="xMidYMid meet">
            ...
            <div class="w-full sm:max-w-md mt-6 mb-6 px-10 py-10 bg-white shadow-md overflow-hidden">
                {{ $slot }}
            </div>
        </div>
    </body>
