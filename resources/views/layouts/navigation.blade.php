<nav x-data="{ open: false }">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="navbar">
            <div class="flex-1">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="60" height="60" viewBox="0 0 299.000000 156.000000" preserveAspectRatio="xMidYMid meet">
            ...
            <div class="flex-none">
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0"
                       ...
                       @guest
                       <li><a href="/login" class="hover:bg-black hover:text-white active:bg-black active:text-white">Login</a></li>
                       <li><a href="/register" class="hover:bg-black hover:text-white active:bg-black active:text-white">Daftar</a></li>
